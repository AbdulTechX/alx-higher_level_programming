...
In this project, i began practicing object-oriented programming using classes and objects in python. i learnded about attributes, methods and properties as well as data abstraction data encapsulation and infomation hiding.
